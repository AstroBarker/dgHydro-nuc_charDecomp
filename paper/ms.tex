...
Sod: Definitely want a $y_{e}$ curve, with and without
characteristic limiting. Perhaps density too, or something. Show comparison
to the nX=10000 run.

Maybe also do the Noh problem, include results from there.
...
\begin{align*}
  ...
  \right]
\end{align*}
where $\phi_{i} = P_{\epsilon}\,\tau\, v_{i}$ and
$\omega = \tau\, (P_{\epsilon}\,(v^2 - 2\epsilon) - 2\,P_{\tau}\,\tau)$.
