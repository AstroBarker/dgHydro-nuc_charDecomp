...
% range of physical conditions. The EOS will provide the thermodynamic quantities such as pressure, 
% internal energy, and entropy as functions of the table variables density, temperature, and electron 
% fraction. These quantities and their derivatives are crucial for the hydrodynamics, nuclear reactions, and 
% neutrino transport as well as the characteristic limiting described in Section~\ref{sec:eigen}. To 
% compute a thermodynamic quantity $\nu$, a thermodynamic grid in $\left( log\, \rho, log\, T, y_{e} \right)$ space 
...
% with respect to $\rho$, $T$, or $y_e$ by differentiating the linear interpolation 
